//
// AES Encryption / Decreyption Class
//
...
void AES::encrypt(unsigned char *key, unsigned char *in, unsigned char *out)
{
	int i,j,round=0;
...
void AES::decrypt(unsigned char *key, unsigned char *in, unsigned char *out)
{
        int i,j,round=0;
